...
@Named(value = "viewBusinessRewardedDeedersMBean")
@RequestScoped
public class ViewBusinessRewardedDeedersMBean {
    
    static final Logger LOGGER=Logger.getLogger(ViewBusinessRewardedDeedersMBean.class.getName());
    ...
    public void init(){
        ...
        int businessId=Integer.valueOf(businessIdStr);
        rewardedDeeders=businessBeanLocal.getBusinessRewardedDeeders(businessId);
