 ...
 * @author root
 */
@Named(value = "viewNgoRewardedDeedersMBean")
@RequestScoped
public class ViewNgoRewardedDeedersMBean {
    
     static final Logger LOGGER=Logger.getLogger(ViewNgoRewardedDeedersMBean.class.getName());
    ...
    public void init(){
        ...
        int ngoId=Integer.valueOf(ngoIdStr);
        rewardedDeeders=ngoBeanLocal.getNgoRewardedDeeders(ngoId);
