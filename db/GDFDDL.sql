...
CREATE TABLE IF NOT EXISTS `BUSINESS_ADDRESS` (
  ...
  CONSTRAINT `fk_BUSINESS_ADDRESS_COUNTRY1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_BUSINESS_ADDRESS_BUSINESS1`
...
CREATE INDEX `fk_BUSINESS_ADDRESS_COUNTRY1_idx` ON `BUSINESS_ADDRESS` (`COUNTRY_CODE` ASC) VISIBLE;

CREATE INDEX `fk_BUSINESS_ADDRESS_BUSINESS1_idx` ON `BUSINESS_ADDRESS` (`BUSINESS_ID` ASC) VISIBLE;
...
CREATE INDEX `fk_ADDRESS_USER1_idx` ON `USER_ADDRESS` (`USER_ID` ASC) VISIBLE;

CREATE INDEX `fk_ADDRESS_COUNTRY1_idx` ON `USER_ADDRESS` (`COUNTRY_CODE` ASC) VISIBLE;
...
CREATE TABLE IF NOT EXISTS `DEED_ADDRESS` (
  ...
  CONSTRAINT `fk_DEEDADDRESS_DEED1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_DEEDADDRESS_COUNTRY1`
    FOREIGN KEY (`COUNTRY_CODE`)
    REFERENCES `COUNTRY` (`CODE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE INDEX `fk_DEEDADDRESS_COUNTRY1_idx` ON `DEED_ADDRESS` (`COUNTRY_CODE` ASC) VISIBLE;
...
CREATE TABLE IF NOT EXISTS `DEEDER_ADDRESS` (
  ...
  `CREATED_ON` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `UPDATED_ON` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`ID`, `DEEDER_ID`),
  CONSTRAINT `fk_ADDRESS_COUNTRY10`
    FOREIGN KEY (`COUNTRY_CODE`)
    REFERENCES `COUNTRY` (`CODE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_DEEDER_ADDRESS_DEEDER1`
    FOREIGN KEY (`DEEDER_ID`)
    REFERENCES `DEEDER` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE INDEX `fk_ADDRESS_COUNTRY1_idx` ON `DEEDER_ADDRESS` (`COUNTRY_CODE` ASC) VISIBLE;

CREATE INDEX `fk_DEEDER_ADDRESS_DEEDER1_idx` ON `DEEDER_ADDRESS` (`DEEDER_ID` ASC) VISIBLE;
...
CREATE TABLE IF NOT EXISTS `ACCESS` (
  ...
  `ACCESS_TYPE` VARCHAR(10) NOT NULL DEFAULT 'USER',
...
-- Table `USER_DEEDER`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `USER_DEEDER` ;

CREATE TABLE IF NOT EXISTS `USER_DEEDER` (
  `USER_ID` INT NOT NULL,
  `DEEDER_ID` INT NOT NULL,
...
CREATE INDEX `fk_USER_has_DEEDER_DEEDER1_idx` ON `USER_DEEDER` (`DEEDER_ID` ASC) VISIBLE;

CREATE INDEX `fk_USER_has_DEEDER_USER1_idx` ON `USER_DEEDER` (`USER_ID` ASC) VISIBLE;
...
CREATE TABLE IF NOT EXISTS `GOVERNMENT` (
  ...
  `UPDATED_ON` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `LOGO_FILE` VARCHAR(50) NULL,
  `CONFIRMED` TINYINT(1) NULL DEFAULT 1,
  `IMAGE` BLOB NOT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE IF NOT EXISTS `GOVERNMENT_ADDRESS` (
  ...
  PRIMARY KEY (`ID`, `GOVERNMENT_ID`),
  CONSTRAINT `fk_GOVT_OFFICE_ADDRESS_COUNTRY1`
    FOREIGN KEY (`COUNTRY_CODE`)
    REFERENCES `COUNTRY` (`CODE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_GOVERNMENT_ADDRESS_GOVERNMENT1`
...
CREATE INDEX `fk_GOVT_OFFICE_ADDRESS_COUNTRY1_idx` ON `GOVERNMENT_ADDRESS` (`COUNTRY_CODE` ASC) VISIBLE;

CREATE INDEX `fk_GOVERNMENT_ADDRESS_GOVERNMENT1_idx` ON `GOVERNMENT_ADDRESS` (`GOVERNMENT_ID` ASC) VISIBLE;
...
CREATE INDEX `fk_NGO_ADDRESS_COUNTRY1_idx` ON `NGO_ADDRESS` (`COUNTRY_CODE` ASC) VISIBLE;
